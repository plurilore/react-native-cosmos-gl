// Generated from shaders/ForceManyBody/force-nearfield.frag by scripts/build-shaders.mjs. Do not edit.
// Derived from cosmos.gl (https://github.com/cosmosgl/graph), MIT licensed.
export const forceManyBodyForceNearfieldFrag = `#version 300 es
...
`
export default forceManyBodyForceNearfieldFrag
