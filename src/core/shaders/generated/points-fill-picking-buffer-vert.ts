// Generated from shaders/Points/fill-picking-buffer.vert by scripts/build-shaders.mjs. Do not edit.
// Derived from cosmos.gl (https://github.com/cosmosgl/graph), MIT licensed.
export const pointsFillPickingBufferVert = `#version 300 es
#ifdef GL_ES
...
void main() {
  ...
  float resolvedSize = cosmosIsNaN(size) ? pointDefaultSize : size;
...
`
export default pointsFillPickingBufferVert
