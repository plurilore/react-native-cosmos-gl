// Generated from shaders/Points/update-position.frag by scripts/build-shaders.mjs. Do not edit.
// Derived from cosmos.gl (https://github.com/cosmosgl/graph), MIT licensed.
export const pointsUpdatePositionFrag = `#version 300 es
#ifdef GL_ES
...
`
export default pointsUpdatePositionFrag
