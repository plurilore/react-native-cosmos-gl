// Generated from shaders/ForceManyBody/force-level.frag by scripts/build-shaders.mjs. Do not edit.
// Derived from cosmos.gl (https://github.com/cosmosgl/graph), MIT licensed.
export const forceManyBodyForceLevelFrag = `#version 300 es
...
`
export default forceManyBodyForceLevelFrag
